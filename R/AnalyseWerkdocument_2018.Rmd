...
df.Ql <- slice(df.Ql, 30:40) # om te testen
#df.Ql <- df.Ql[df.Ql$QID %in% c("Q25", "Q26", "Q29", "Q27", "Q28", "Q96", "Q97"),]  # Dient enkel om te testen
df.Ql$pAID <- "none"
